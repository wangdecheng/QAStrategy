...
class Strategy:                                                                             # 定义策略类
    ...
    def __init__(self):
        ...
        self.buy_signal, self.sell_signal, self.ma20, self.ma30 = [], [], [], []            # 在遍历k线的代码前定义几个实例属性：买入信号，卖出信号，ma20，ma30
        ...
        plot_signal(data, self.buy_signal, self.sell_signal, self.ma20, self.ma30)          # 回测完成绘制k线及显示买卖信号
    ...
    def begin(self):                                                                        # 定义实例方法，策略主体
        ...
        self.ma20 = ma20                                                                    # 将ma20和ma30赋值给self.ma20和self.ma30，用以传指标数据给plot_signal方法
        self.ma30 = ma30
